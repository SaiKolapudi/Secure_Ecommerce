...
# Make sure to replace <password> with your actual password and <dbname> with your actual database name
client = MongoClient("mongodb+srv://saitulasi1729:naABWfvcueIbZ1dG@cluster0.gfe8iaf.mongodb.net/grocery_store?retryWrites=true&w=majority")

# Connect to the specific database
db = client['grocery_store']  # Replace 'grocery_store' with your actual database name if different
